...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    openGraph: {
      ...
      description: resource.description,
      images: resource.image ? [{ url: resource.image }] : [{ url: '/og-image.jpg' }],
    },
  }
}
    ...
    <div className="pt-16 pb-24 lg:pt-12">
      <Container>
        ...
        <div className="mt-8 lg:grid lg:grid-cols-3 lg:gap-12">
          ...
          <div className="flex flex-col items-center lg:items-start">
            ...
            <div className="mt-6 w-56 rounded-xl border border-slate-200 bg-slate-50 p-4 text-sm lg:w-full">
              <dl className="space-y-3">
                <div>
                  <dt className="font-mono text-xs font-semibold uppercase tracking-wide text-slate-500">
                    Category
                  </dt>
          ...
          {/* Right: title + description + review */}
